...
import { patients, currentUser } from "../workspace/mock-data";
...
export default function WorkspacePage() {
  ...
  // ✨ 너비를 300px에서 380px로 약 26% 증가
  const workspaceStyle = { "--ws-grid": "380px 1fr" } as CSSProperties;

  // 체크박스와 연구 목적 여부를 포함한 8개 열의 너비 지정
