...
public enum ErrorCode {
    ...
    STUDY_NOT_SYNCED(HttpStatus.CONFLICT, "DICOM_006", "해당 스터디가 아직 PACS와 동기화되지 않았습니다."),
    SERIES_NOT_SYNCED(HttpStatus.CONFLICT, "DICOM_007", "해당 시리즈가 아직 PACS와 동기화되지 않았습니다."),
