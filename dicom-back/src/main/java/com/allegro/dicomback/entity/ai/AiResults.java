...
public class AiResults {
    ...
    // 원래는 study이지만 현재 ai판독 요청 detect-raw는 뷰어에서 지금 화면에 떠 있는 사진(Dicom) 한 장을 호출하기에 변경됨
    // 어떤 검사였다 보다 어느 시리즈의 몇번째 이미지인지 나타내는 역할 (SeriesKey 외래키)
